...
1. Orientation: Always read `.loom/context/skeleton.md` before any task. If `.loom/context/skeleton.json` exists, use it as structured context. Map plan before reading full files.
